<div class="container my-5">
    ...
    ?>
        ...
        <div class="row mx-2 py-1 mb-2 bg-white rounded-3 shadow-sm text-dark">
        ...
        <?php foreach ($baskets as $row) { ?>
            <div class="row mx-2 py-2 mb-2 border-bottom bg-white rounded-3 shadow-sm text-dark">
                <div class="col-8 col-md-6 d-flex align-items-center">
                    ...
                    <div class="ms-md-4">
                        <h4 class="mb-0 text-capitalize fw-light"><?php echo $row['cd_name']; ?></h4>
    ...
    <?php } else if (isset($orders) && is_array($orders) && $orders !== false) {  ?>
        ...
        <div class="row mx-2 p-1 mb-2 bg-white rounded-3 shadow-sm text-dark">
            <div class="col-8 col-md-6"><small>Order Information</small></div>
            <div class="col-2 text-center d-none d-md-block"><small>Price</small></div>
            <div class="col-2 text-center d-none d-md-block"><small>Quantity</small></div>
        ...
        <?php foreach ($orders as $row) { ?>
            <div class="row mx-2 py-1 mb-2 border-bottom bg-white rounded-3 shadow-sm text-dark">
                <div class="col-8 col-md-6 d-flex align-items-center">
                    ...
                    <div class="ms-md-4">
                        <h4 class="mb-0 fw-light text-capitalize"><?php echo $row['cd_name']; ?></h4>
                        <p class="mb-0 text-capitalize text-muted"><?php echo $row['ud_full_name']; ?>'s Shop</p>
                    </div>
                </div>
                <div class="col text-center d-none d-md-flex align-items-center justify-content-center">
