...
$route['api/get_table'] = 'BookTableController/getAllAvailableTableAPI';
$route['api/set_booking_table'] = 'BookTableController/setTableBookingAPI';
$route['api/set_remove_table'] = 'BookTableController/removeTableBookingAPI';
